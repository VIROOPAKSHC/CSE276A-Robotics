...
DIST_ERROR_MARGIN = 0.1  # distance error margin to consider waypoint reached
ORIENT_ERROR_MARGIN = 0.05  # ORIENTATION error margin to consider orientation reached  
DT = 0.08   # time step for each sub-simulation or the sub-segment simulation in seconds              

KP_OMEGA = 1 # constant for Proportionality for the BODY's angular velocity     
KD_OMEGA = 0.1 # constant for Derivative method for the BODY's angular velocity     
KP_V = 0.15  # constant for Proportionality for the BODY's linear velocity
...
def run_pose_tracking(waypoints_with_pose):
    ...
    ORIENT_DT  = 0.03           # Time step size while rotation
    MAX_STEPS_ROT = 800           # total number of steps needed for the rotation
